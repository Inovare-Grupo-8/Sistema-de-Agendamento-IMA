  ...
  const confirmCancelAppointment = () => {
    if (selectedAppointment) {
      ...
      toast({
        ...
        description: `A consulta de ${selectedAppointment.patientName} foi cancelada com sucesso.`,
      });
    }
                ...
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-12 text-center animate-fade-in">
                    ...
                    <div className="text-gray-400 dark:text-gray-500 text-sm">
                      Não há consultas agendadas que correspondam à sua busca.
                    </div>
                  </div>
                ) : (
                          ...
                          <div className="p-4">
                            ...
                            {appointment.status !== "cancelled" && (
                              <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-800 flex gap-2">
                                <Button
                                  variant="outline"
                                  className="flex-1 border-[#ED4231] text-[#ED4231] hover:bg-[#ED4231] hover:text-white transition-colors"
                                >
                                  Reagendar
                                </Button>
                                <Button
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {selectedAppointment?.patientName} às {selectedAppointment?.time}?
            </DialogDescription>
          </DialogHeader>
