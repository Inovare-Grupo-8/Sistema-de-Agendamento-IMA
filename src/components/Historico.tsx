  ...
  useEffect(() => {
    const loadHistorico = async () => {
      ...
      try {
        ...
        // Load historical consultations (volunteer view)
        ...
        console.log(
          "🔥 [Historico] Dados brutos da API getHistoricoConsultas:",
          {
            userId,
        ...
        // For volunteers, show assisted user name
        const historicoFormatted: HistoricoAtendimento[] = historicoData.map(
          (consulta) => {
            const consultaDate = new Date(consulta.horario);
            const consultaId = consulta.idConsulta;

            console.log("🔍 [Historico] Processando consulta:", {
              id: consultaId,
            ...
            // Get patient name from direct field or nested object as fallback
            const patientName =
        ...
        console.log(
          "📊 [Historico] Histórico formatado final:",
          historicoFormatted
        );
          ...
          <div className="pt-20 md:pt-24 min-h-screen">
            <div className="max-w-5xl mx-auto p-4 md:p-8">
              ...
              <div
                className="space-y-4"
                role="region"
                aria-label="Lista de atendimentos históricos"
                ref={listRef}
              >
                {loading ? (
                  <div
                        ...
                        <div className="p-4">
                          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-3">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <Badge
                                className={`${
                                  statusColors[atendimento.status]
                                } px-3 py-1 rounded-full text-xs font-medium`}
                              >
                                {atendimento.status === "realizada"
                                  ? "Realizada"
                                  : atendimento.status === "cancelada"
                                  ? "Cancelada"
                                  : "Remarcada"}
                              </Badge>
                            </div>
