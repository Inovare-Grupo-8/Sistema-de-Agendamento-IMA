...
const PagamentoUser = () => {
  ...
  const [availableServices, setAvailableServices] =
    useState<ServiceItem[]>(DEFAULT_SERVICES);
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setLoadingState({
        type: "validation",
        message: "Validando dados do pagamento...",
      });
      ...
      const response = await fetch(buildBackendUrl(`/pagamentos`), {
        method: "POST",
        headers: {
        ...
        <div className="flex flex-col items-center gap-6 max-w-md w-full">
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {loadingState.type === "initial" && (
                <CreditCard className="w-6 h-6 text-[#ED4231]" />
              )}
              {loadingState.type === "services" && (
                <Calendar className="w-6 h-6 text-[#ED4231]" />
              )}
              {loadingState.type === "payment" && (
                <Shield className="w-6 h-6 text-[#ED4231]" />
              )}
              {loadingState.type === "validation" && (
                <Check className="w-6 h-6 text-[#ED4231]" />
              )}
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-1">
              ...
              <div
                className="w-2 h-2 bg-[#ED4231] rounded-full animate-bounce"
      ...
      <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#EDF2FB] dark:bg-gray-900">
        ...
        >
          ...
          <div className="w-full flex justify-start mb-6">
            ...
            {isMobile && (
              <span className="ml-3 font-semibold text-indigo-900 dark:text-gray-100 self-center">
                Menu
              </span>
            )}
          </div>
        ...
        >
          ...
          <header className="w-full flex items-center justify-between px-4 md:px-6 py-4 bg-white/90 dark:bg-[#23272F]/95 shadow-md fixed top-0 left-0 z-20 backdrop-blur-md transition-colors duration-300 border-b border-[#EDF2FB] dark:border-[#23272F]">
            <div className="flex items-center gap-3">
              ...
              />
              <span
                className={`font-bold text-indigo-900 dark:text-gray-100 ${
                  isMobile ? "text-sm" : ""
                }`}
              >
                {displayName}
          ...
          <div
            className={`max-w-6xl mx-auto p-2 sm:p-4 md:p-8 ${
              isMobile ? "pt-20" : "pt-24 sm:pt-28 md:pt-24"
            }`}
          >
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h1
                    ...
                    } font-bold text-indigo-900 dark:text-gray-100 mb-2`}
                  >
                  ...
                  >
                    {isMobile
                      ...
                      : "Finalize o pagamento dos seus serviços selecionados"}
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <motion.div
                  ...
                  className={`${
                    isMobile ? "order-1" : "lg:col-span-1 order-2 lg:order-1"
                  }`}
                >
                  <Card
                    className={`bg-white dark:bg-[#23272F] border-[#EDF2FB] dark:border-[#444857] ${
                ...
                <motion.div
                  ...
                  className={`${
                    isMobile ? "order-2" : "lg:col-span-2 order-1 lg:order-2"
                  }`}
                >
                          ...
                          >
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                placeholder="MM/AA"
                                className={`mt-1 ${
                                  fieldErrors.cardExpiry ? "border-red-500" : ""
                                }`}
                                maxLength={5}
                              />
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                onChange={(e) =>
                                  handleFieldChange("cardCVV", e.target.value)
                                }
                                placeholder="123"
                                className={`mt-1 ${
                                  fieldErrors.cardCVV ? "border-red-500" : ""
                                }`}
                                maxLength={4}
                              />
                              {fieldErrors.cardCVV && (
                            ...
                            >
                              ...
                              <Select
                                ...
                                onValueChange={(value) =>
                                  handleFieldChange("installments", value)
                                }
                              >
                                ...
                                <SelectContent>
                                  ...
                                  <SelectItem value="2">
                                    2x de R$ {(finalTotal / 2).toFixed(2)}
                                  </SelectItem>
                                  <SelectItem value="3">
                                    3x de R$ {(finalTotal / 3).toFixed(2)}
                                  </SelectItem>
                                  <SelectItem value="4">
                                    4x de R$ {(finalTotal / 4).toFixed(2)}
                                  </SelectItem>
                                  <SelectItem value="5">
                                    5x de R$ {(finalTotal / 5).toFixed(2)}
                                  </SelectItem>
                                  <SelectItem value="6">
                                    6x de R$ {(finalTotal / 6).toFixed(2)}
                                  </SelectItem>
                                </SelectContent>
                              </Select>
                            </div>
                        ...
                        >
                          <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
                            ...
                            <p className="text-sm text-yellow-700 dark:text-yellow-300">
                              O boleto será gerado após a confirmação e enviado
                              por email. O pagamento pode levar até 3 dias úteis
                              para ser processado.
                            </p>
                          </div>
                        </motion.div>
        ...
        <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
          <DialogContent className={`${isMobile ? "w-[95vw] max-w-md" : ""}`}>
            ...
            <DialogFooter className={`${isMobile ? "flex-col gap-2" : ""}`}>
              <Button
                variant="outline"
                onClick={() => navigate("/consultas-user")}
