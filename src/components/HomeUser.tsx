...
const HomeUser = () => {
  ...
  const [consultaParaCancelar, setConsultaParaCancelar] =
    useState<ConsultaCancelamento | null>(null);
  ...
  const loadHistoricoRecente = useCallback(async (consultas: Consulta[]) => {
    try {
      ...
      const consultasComAvaliacao = historicoFormatted.filter(
        (consulta) => consulta.avaliacao != null
      );
  ...
  const abrirModalCancelamento = (
    consulta: Consulta | ConsultaCancelamento
  ) => {
    setConsultaParaCancelar({
      ...
      tipo: consulta.tipo,
      especialidade:
        "especialidade" in consulta ? consulta.especialidade : undefined,
    });
                                      ...
                                      <div className="flex items-center gap-1">
                                        ...
                                        <Tooltip>
                                          ...
                                          <TooltipContent>
                                            <p>
                                              Sua avaliação:{" "}
                                              {consulta.avaliacao} de 5 estrelas
                                            </p>
                                          </TooltipContent>
                                        </Tooltip>
                                      </div>
