...
export default function ProfileFormAssistenteSocial() {
  ...
  const [formData, setFormData] = useState<AssistenteSocialFormData>(
    assistenteSocialDataDefault
  );
  // Estado para dados originais (para exibição na sidebar - não muda durante edição)
  const [originalData, setOriginalData] = useState<AssistenteSocialFormData>(
    assistenteSocialDataDefault
  );
  ...
  const {
    ...
    atualizarEndereco,
    uploadFoto,
  } = useAssistenteSocial(); // Função para carregar dados do perfil
  useEffect(() => {
    const carregarPerfil = async () => {
      try {
        ...
        try {
          ...
          console.log(
            "Erro ao carregar endereço (usando dados padrão):",
            enderecoError
          );
        }
        ...
        const dadosCompletos = {
          ...
          dataNascimento:
            dados.dataNascimento || assistenteSocialDataDefault.dataNascimento,
          genero: dados.genero || assistenteSocialDataDefault.genero,
          crp: dados.crp || assistenteSocialDataDefault.crp,
          especialidade:
            dados.especialidade || assistenteSocialDataDefault.especialidade,
        ...
        toast({
          ...
          description:
            "Não foi possível carregar os dados do perfil. Usando dados padrão.",
          variant: "destructive",
        });
      }
    };

    // Carregar perfil inicialmente
    carregarPerfil();

    // Recarregar de 5 em 5 minutos (300000ms)
    const intervalId = setInterval(() => {
      console.log("Recarregando dados do perfil (5 minutos)...");
      carregarPerfil();
    }, 300000); // 5 minutos
  ...
  const handleSavePersonalData = async () => {
    ...
    try {
      ...
      if (formData.telefone && formData.telefone.trim()) {
        ...
        if (phoneError) {
          toast({
            ...
            description:
              "Por favor, use o formato (XX) XXXXX-XXXX ou (XX) XXXX-XXXX",
            variant: "destructive",
          });
          return;
        }
      ...
      setFormData((prevData) => ({
        ...
        dataNascimento:
          dadosAtualizados.dataNascimento || prevData.dataNascimento,
      ...
      setSuccessMessage(
        "Dados pessoais e profissionais atualizados com sucesso!"
      );
      ...
      if (emailAlterado) {
        ...
        toast({
          ...
          description:
            "Todos os dados pessoais e profissionais foram atualizados com sucesso.",
        });
      }
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Ocorreu um erro ao salvar suas informações pessoais.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    try {
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Ocorreu um erro ao salvar seus dados profissionais.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
    ...
    try {
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "Ocorreu um erro ao salvar seu endereço.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
        ...
        {!sidebarOpen && (
          <div className="w-full flex justify-start items-center gap-3 p-4 fixed top-0 left-0 z-30 bg-white/80 dark:bg-[#23272F]/90 shadow-md backdrop-blur-md">
            ...
            <span className="font-bold text-indigo-900 dark:text-gray-100">
              {originalData.nome} {originalData.sobrenome}
            </span>
          </div>
        )}
        <div
                  ...
                  <Card className="bg-white dark:bg-[#23272F] border-[#EDF2FB] dark:border-[#444857]">
                    ...
                    <CardFooter className="flex justify-between">
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            disabled={
                              loading || (!formChanged && !selectedImage)
                            }
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top">
                          <p>
                            Salvar alterações no nome e email (dados básicos)
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </CardFooter>
                ...
                <TabsContent value="endereco">
                  <Card className="bg-white dark:bg-[#23272F] border-[#EDF2FB] dark:border-[#444857]">
                    <CardHeader>
                      ...
                      <CardDescription>
                        Atualize seu endereço profissional
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            <Tooltip>
                              ...
                              <TooltipContent side="top">
                                <p>
                                  Formato: 00000-000 (preenchimento automático
                                  ao sair do campo)
                                </p>
                              </TooltipContent>
                            </Tooltip>
      ...
      >
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Seu email foi alterado com sucesso. Por motivos de segurança, você
              será redirecionado para a página de login para reautenticar com o
              novo email.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
