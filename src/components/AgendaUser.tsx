...
const AgendaUser = () => {
  ...
  const [consultaCancelamento, setConsultaCancelamento] =
    ...
    <SidebarProvider>
      ...
      >
        ...
        <main
          id="main-content"
          role="main"
          aria-label="Conteúdo principal da agenda"
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>
                        Número total de consultas agendadas para os próximos
                        dias
                      </p>
                    </TooltipContent>
                  </Tooltip>
                            ...
                            <div className="flex gap-1">
                              ...
                              {consulta.status === "agendada" && (
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p>
                                      Cancelar esta consulta (pode haver taxas)
                                    </p>
                                  </TooltipContent>
                                </Tooltip>
                              )}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <p>
                      <strong>Data:</strong>{" "}
                      {format(consultaDetalhes.data, "dd 'de' MMMM 'de' yyyy", {
                        locale: ptBR,
                      })}
                    </p>
                    <p>
              ...
              {consultaDetalhes.tipo === "Consulta Online" ? (
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    <p>
                      <strong>Plataforma:</strong> Google Meet
                    </p>
                    <p>
                      <strong>Link da reunião:</strong> Será enviado 30 minutos
                      antes da consulta
                    </p>
                    <p>
                ...
                <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">
                    <p>
                      <strong>Local:</strong> Instituto Inovare
                    </p>
                    <p>
                    ...
                    <p>
                      <strong>Sala:</strong> Consultório 2 - 2º Andar
                    </p>
                    <p>
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
                <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-3 flex items-center gap-2">
                  <svg
                    ...
                    strokeLinejoin="round"
                  >
                    <path d="M3 3v5h5M3 21v-5h5m13-13v5h-5m5 5v5h-5" />
                  </svg>
                  Histórico
                </h4>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <div className="flex">
                          {Array.from({ length: 5 }, (_, index) => (
                            <svg
                              key={index}
                              className={`w-4 h-4 ${
                                index < consultaDetalhes.avaliacao!
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {consultaCancelamento.profissional}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">
                    ...
                    <span className="font-medium text-gray-900 dark:text-gray-100">
                      {consultaCancelamento.especialidade}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-yellow-700 dark:text-yellow-300">
                      Cancelamentos com menos de 24 horas de antecedência podem
                      estar sujeitos a taxas. Consulte os termos de uso para
                      mais informações.
                    </p>
                  </div>
                </div>
          ...
          <DialogFooter className="gap-2 sm:gap-0">
            ...
            <Button
              ...
              onClick={async () => {
                ...
                try {
                  await ConsultaApiService.cancelarConsulta(
                    consultaCancelamento.id
                  );
                  toast({
