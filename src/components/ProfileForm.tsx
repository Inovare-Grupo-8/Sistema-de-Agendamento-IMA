    ...
    const SuggestionInput = ({
        ...
        <div className="space-y-2 relative">
            ...
            <Input
                ...
                onChange={onChange}
                onBlur={onBlur}
                className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${error ? 'border-red-500' : ''}`}
                autoComplete="off"
            ...
            {suggestions.length > 0 && (
                <ul className="bg-white border rounded shadow absolute z-10 w-full" role="listbox" aria-label={`Sugestões para ${label}`}> 
                    {suggestions.map(s => (
                        <li key={s} role="option" className="px-2 py-1 hover:bg-gray-200 cursor-pointer" onMouseDown={() => onSuggestionClick(s)}>{s}</li>
                    ))}
                </ul>
            )}
        </div>
            ...
            <div className="min-h-screen w-full flex flex-col md:flex-row text-lg md:text-xl bg-[#EDF2FB]">
                {!sidebarOpen && (
                    <div className="w-full flex justify-start items-center gap-3 p-4 fixed top-0 left-0 z-30 bg-white/80 shadow-md backdrop-blur-md">
                        <button onClick={() => setSidebarOpen(true)} className="p-2 rounded-full bg-[#ED4231] text-white focus:outline-none shadow-md focus:ring-2 focus:ring-[#ED4231]">
                ...
                <div className={`transition-all duration-500 ease-in-out
                    ...
                    <SidebarMenu className="gap-4">
                        <SidebarMenuItem>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <SidebarMenuButton asChild className={`rounded-xl px-4 py-3 font-semibold transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${location.pathname === '/agenda' ? 'bg-[#EDF2FB] border-l-4 border-[#ED4231]' : ''}`}>
                        ...
                        <SidebarMenuItem>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <SidebarMenuButton asChild className={`rounded-xl px-4 py-3 font-semibold transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${location.pathname === '/disponibilizar-horario' ? 'bg-[#EDF2FB] border-l-4 border-[#ED4231]' : ''}`}>
                        ...
                        <SidebarMenuItem>
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <SidebarMenuButton asChild className={`rounded-xl px-4 py-3 font-semibold transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${location.pathname === '/profile-form' ? 'bg-[#EDF2FB] border-l-4 border-[#ED4231]' : ''}`}>
                ...
                <div className={`flex-1 w-full md:w-auto mt-4 md:mt-0 transition-all duration-500 ease-in-out ${sidebarOpen ? '' : 'ml-0'}`}>
                    ...
                    <div className="max-w-5xl mx-auto p-6">
                        ...
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8" aria-live="polite" role="form">
                            <div className="space-y-6">
                                <Progress value={progress} className="my-4" />
                                <div className="text-xs text-gray-600 mb-2">Perfil {progress}% completo</div>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <label htmlFor="nome" className="block text-sm font-medium cursor-help">Nome</label>
                                            </TooltipTrigger>
                                        ...
                                        <Input
                                            ...
                                            className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.nome ? 'border-red-500' : ''}`}
                                    ...
                                    <div className="space-y-2">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <label htmlFor="sobrenome" className="block text-sm font-medium cursor-help">Sobrenome</label>
                                            </TooltipTrigger>
                                        ...
                                        <Input
                                            ...
                                            className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.sobrenome ? 'border-red-500' : ''}`}
                                ...
                                <div className="space-y-2">
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <label htmlFor="email" className="block text-sm font-medium cursor-help">Email</label>
                                        </TooltipTrigger>
                                    ...
                                    <Input
                                        ...
                                        className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.email ? 'border-red-500' : ''}`}
                                ...
                                <div className="space-y-2">
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <label htmlFor="emailConfirm" className="block text-sm font-medium cursor-help">Confirme seu Email</label>
                                        </TooltipTrigger>
                                    ...
                                    <Input
                                        ...
                                        className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.emailConfirm ? 'border-red-500' : ''}`}
                                ...
                                <div className="space-y-2">
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <label htmlFor="endereco" className="block text-sm font-medium cursor-help">Endereço</label>
                                        </TooltipTrigger>
                                    ...
                                    <Input
                                        ...
                                        className="border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none"
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    <Tooltip>
                                        <TooltipTrigger asChild>
                                            <label htmlFor="telefone" className="block text-sm font-medium cursor-help">Telefone/WhatsApp</label>
                                        </TooltipTrigger>
                                    ...
                                    <Input
                                        ...
                                        className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.telefone ? 'border-red-500' : ''}`}
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    <div className="space-y-2">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <label htmlFor="cpf" className="block text-sm font-medium cursor-help">CPF</label>
                                            </TooltipTrigger>
                                        ...
                                        <Input
                                            ...
                                            className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.cpf ? 'border-red-500' : ''}`}
                                    ...
                                    <div className="space-y-2">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <label htmlFor="cep" className="block text-sm font-medium cursor-help">CEP</label>
                                            </TooltipTrigger>
                                        ...
                                        <Input
                                            ...
                                            className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.cep ? 'border-red-500' : ''}`}
                                    ...
                                    <div className="space-y-2">
                                        <Tooltip>
                                            <TooltipTrigger asChild>
                                                <label htmlFor="nascimento" className="block text-sm font-medium cursor-help">Data de Nascimento</label>
                                            </TooltipTrigger>
                                        ...
                                        <Input
                                            ...
                                            className={`border border-[#ADADAD] border-solid border-2 rounded-[20px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none ${errors.nascimento ? 'border-red-500' : ''}`}
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="atividade" className="block text-sm font-medium">Atividade a se cedida como voluntariado:</label>
                                    <Textarea
                                        value={formData.atividade}
                                        onChange={(e) => setFormData({ ...formData, atividade: e.target.value })}
                                        className="border border-[#ADADAD] border-solid border-2 rounded-[20px] min-h-[100px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none"
                                    />
                                </div>

                                <div className="space-y-2">
                                    <label htmlFor="bio" className="block text-sm font-medium">Mini bio</label>
                                    <Textarea
                                        id="bio"
                                        value={bio}
                                        onChange={e => setBio(e.target.value)}
                                        className="border border-[#ADADAD] border-solid border-2 rounded-[20px] min-h-[80px] bg-[#EDF2FB] focus:ring-2 focus:ring-[#ED4231] focus:outline-none"
                                        aria-label="Mini bio"
                                    />
                                </div>
