...
import {
  ...
  useAssistenteSocial,
} from "@/hooks/useAssistenteSocial";
import {
  SidebarProvider,
  SidebarMenu,
  SidebarMenuItem,
...
export default function CadastroAssistenteSocial() {
  ...
  const [assistenteSocialData, setAssistenteSocialData] =
    useState<AssistenteSocialViewModel>({
      idUsuario: 0,
      nome: "",
      sobrenome: "",
      crp: "",
      ...
      <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#EDF2FB] dark:bg-gradient-to-br dark:from-[#181A20] dark:via-[#23272F] dark:to-[#181A20] transition-colors duration-300 font-sans">
        ...
        <div className="flex-1 overflow-auto">
          <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#EDF2FB] dark:bg-gradient-to-br dark:from-[#181A20] dark:via-[#23272F] dark:to-[#181A20]">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SidebarMenuButton
                        asChild
                        className={`rounded-xl px-4 py-3 font-normal text-sm md:text-base transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 ${
                          location.pathname === "/classificacao-usuarios"
                            ? "bg-[#EDF2FB] border-l-4 border-[#ED4231]"
                            : ""
                        }`}
                      >
                        <Link
                          to="/classificacao-usuarios"
                          className="flex items-center gap-3"
                        >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SidebarMenuButton
                        asChild
                        className={`rounded-xl px-4 py-3 font-normal text-sm md:text-base transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 ${
                          location.pathname === "/cadastro-assistente"
                            ? "bg-[#EDF2FB] border-l-4 border-[#ED4231]"
                            : ""
                        }`}
                      >
                        <Link
                          to="/cadastro-assistente"
                          className="flex items-center gap-3"
                        >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SidebarMenuButton
                        asChild
                        className={`rounded-xl px-4 py-3 font-normal text-sm md:text-base transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 ${
                          location.pathname === "/cadastro-voluntario"
                            ? "bg-[#EDF2FB] border-l-4 border-[#ED4231]"
                            : ""
                        }`}
                      >
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <SidebarMenuButton
                        ...
                        className={`rounded-xl px-4 py-3 font-normal text-sm md:text-base transition-all duration-300 hover:bg-[#ED4231]/20 focus:bg-[#ED4231]/20 ${
                          location.pathname ===
                          "/profile-form-assistente-social"
                            ? "bg-[#EDF2FB] border-l-4 border-[#ED4231]"
                            : ""
                        }`}
                      >
                        <Link
                          to="/profile-form-assistente-social"
                          className="flex items-center gap-3"
                        >
            ...
            {/* Main content */}
            <main
              className={`flex-1 w-full md:w-auto mt-20 md:mt-0 transition-all duration-500 ease-in-out ${
                sidebarOpen ? "" : "ml-0"
              } p-4 md:p-8`}
            >
              <div className="max-w-4xl mx-auto">
                ...
                <Card className="bg-white dark:bg-[#23272F] border-[#EDF2FB] dark:border-[#444857]">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Informe os dados do novo assistente social
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label
                          htmlFor="voluntario.especialidade"
                          className="flex items-center justify-between"
                        >
                          Especialidade
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={handleInputChange}
                          className={
                            validationErrors.profissao ? "border-red-500" : ""
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={handleInputChange}
                          className={
                            validationErrors.senha ? "border-red-500" : ""
                          }
                        />
                      </div>
                      <div className="space-y-2">
